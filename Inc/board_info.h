...
#define  EX_FLASH_CACHE_ADDR		 0x0800							//外部缓存地址
...
==================================================================================*/
#define  SOFT_VERSION					(0x03)		//软件版本 1个字节
#define  HARD_VERSION					(0x02)		//硬件版本 1个字节
#define  MACHINE_TYPE					(0x05)		//机器种类码 2个字节
#define  BOARD_TYPE						(0x02)		//板卡类型 1个字节

/*==========================FLASH地址分配表=========================*/
#define   APP_START_ADDR			0x08002000					//用户程序起始地址
#define   APP_CACHE_ADDR			EX_FLASH_CACHE_ADDR					//升级程序缓存地址
#define   IAP_FLAG_ADDR				0x00000000					//升级配置参数地址
